...
> audition (all types) are built and DEVICE-VERIFIED, with a 106-test off-device suite
...
Tests/                               Off-device unit tests (macOS MidiSparkTests target, 106 tests over the
