...
func macroParamsForProcessor(_ type: ProcessorType) -> [MacroControlParam] {
    ...
    case .octave, .transpose, .channel, .nudge, .dest, .muteMatrix, .riff:
        return [bypass]   // UTILITY/ROUTING/RIFF (Paul 2026-08-22): edited directly (the rank stencil isn't a simple macro-foldable scalar)
    }
}
