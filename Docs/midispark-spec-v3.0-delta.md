...
- RECORDED, UNDESIGNED (2026-07 — the user will expand these in a future
  ...
  1. **THE TRIGGER SYSTEM (2026-07-24 — TOUCH widened to FIVE per-Colour
     ...
     **THE COLUMN "ON" SYSTEM (2026-07-24 — the framework applied to the
     ...
     config and propagate to the selected set like the input/output edits. The
     occupied-cell popup editor is GONE (single tap now hides-with-undo; long-press
     stages). GUI shipped engine-inert (iteration 1); demonstration-then-commit +
     the derive-law engine = the recorded next iteration.
