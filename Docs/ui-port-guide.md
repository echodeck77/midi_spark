...
> surface**, with the rig config reached from header buttons (RACK · RECORD; RATE
> on the ferry-settings card, MIDI IN/OUT via the machine-column strips). For the live reference, use the BUILD mock
