...
- **THE CONFIG SHEETS** (`Docs/AcceptanceCriteria/AcceptanceCriteria-config-sheets.md`, 2026-08-20 — big reframe, Paul
  ...
  **RECORD BUTTON MOVE DONE** (2026-08-21, `43ba611` — the reel/RECORD glyph moved from the bottom-left cluster to the
  BUILD page's TOP-RIGHT corner, layered under the sheets; the bottom cluster is now RATE + MIDI CONFIG + RACK CONFIG;
  device eye owed for corner overlap with the part-grid eye/rate). DEVICE eye owed on the inline matrix (it now
